...
public class ApoliceSeguro {
	...
	private Long codigo;
	private BigDecimal valorFranquia = BigDecimal.ZERO;
	private Boolean protecaoTerceiro = Boolean.FALSE;
	private Boolean protecaoCausasNaturais = Boolean.FALSE;
	private Boolean protecaoRoubo = Boolean.FALSE;
